...
})({"dIl4S":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f6e48be005476d29";
"use strict";
...
},{}],"cmF1t":[function(require,module,exports) {
JSON.parse('{"manifest_version":3,"name":"Sorter","version":"0.0.1","background":{"service_worker":"","type":"module"},"permissions":["tabs","tabGroups","scripting"],"content_scripts":[{"matches":["*://github.com/parcel-bundler/*"],"js":["",""]}],"commands":{"sort":{"suggested_key":{"default":"Ctrl+Shift+P","mac":"Command+Shift+P"},"description":"Run \\"sort\\" on the current page."}},"content_security_policy":{"extension_pages":"script-src \'self\' http://localhost:*;object-src \'self\';"},"host_permissions":["*://github.com/parcel-bundler/*"]}');

},{}],"cIW0T":[function(require,module,exports) {
    ...
    if (command === "sort") {
        ...
        chrome.tabs.query({}, (tabs)=>{
            const sortedTabs = tabs.sort((a, b)=>{
                ...
                if (domainA === domainB) return a.lastAccessed - b.lastAccessed;
            ...
            chrome.tabGroups.query({}, (tabGroups)=>{
                ...
                chrome.tabs.query({
                    ...
                    tabGroups.forEach((tabGroup)=>{
                        if (tabGroup.id !== activeTabGroupId) chrome.tabGroups.update(tabGroup.id, {
                            collapsed: true
                        });
                    });
                });
